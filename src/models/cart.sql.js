...
`SELECT product_option_combination AS productOptionComb FROM Product_Option_Comb 
WHERE id = ?;`
...
`UPDATE Cart_Item SET quantity = ?, total_price = ?, product_option_id = ? WHERE id = ? and cart_id;`
