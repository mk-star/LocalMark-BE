...
import { letterList, letterInfo, recentLetters, eventList, eventInfo, recentEvents, addNewLetter } from "../controllers/morelocal.controller.js";
...
morelocalRouter.patch('/letter/:letterId', asyncHandler());   // 수정
